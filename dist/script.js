  ...
  render() {
    ...
    return /*#__PURE__*/(
      ...
      drumPads.map((pad, idx) => {
        ...
        return /*#__PURE__*/(
          React.createElement(DrumPad, { id: pad.id, now: this.state.keyRightNow, onClick: this.callMeMaybe.bind(this, pad), value: pad.value, src: pad.src, name: pad.name }));
      ...
      React.createElement(ControlPanel, { play: this.state.playingNow }))));
...
class DrumPad extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      React.createElement("button", { id: this.props.name, className: "drum-pad btn btn-primary", onClick: this.handleClick.bind(this), name: this.props.id }, /*#__PURE__*/
      React.createElement("audio", { src: this.props.src, id: this.props.id,
        type: "audio/mp3", className: "clip" }), /*#__PURE__*/
...
class ControlPanel extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement("h4", null, "Now Playing:"), /*#__PURE__*/
      React.createElement("h5", null, this.props.play)));
...
ReactDOM.render( /*#__PURE__*/React.createElement(DrumMachine, { id: "drum-machine" }), document.getElementById("drum-machine"));
